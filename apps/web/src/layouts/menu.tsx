...
export const menuItems: MenuProps['items'] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/settings/remote-access', icon: <SafetyCertificateOutlined />, label: 'Удалённый доступ' },
...
export const pageDescriptions: Record<string, string> = {
  ...
  onlineRequests: 'Входящие заявки владельцев на приём для подтверждения клиникой.',
  ...
  laboratories: 'Анализы, связанные услуги, документы результатов и рабочий журнал.',
  ...
  'remote-access': 'Персональный удалённый просмотр сотрудников, доверенные устройства и история входов.',
