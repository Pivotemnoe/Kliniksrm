...
import { AdmitHospitalInput, CreateHospitalRecordInput, HospitalCatalog, HospitalRecord, HospitalResources, HospitalStay, HospitalStayStatus, UpdateHospitalRecordInput } from './types';
