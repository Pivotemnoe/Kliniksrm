...
import { AdmitHospitalInput, CreateHospitalAmendmentInput, CreateHospitalRecordInput, HospitalCatalog, HospitalRecord, HospitalResources, HospitalStay, HospitalStayStatus, UpdateHospitalRecordInput } from './types';
