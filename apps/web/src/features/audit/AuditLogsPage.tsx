...
const actionLabels: Record<string, string> = {
  ...
  'auth.remote_login_blocked': 'Удалённый вход заблокирован',
  'remote_access.invitation_create': 'Удалённый доступ сотруднику выдан',
  'remote_access.invitation_revoke': 'Приглашение удалённого доступа отменено',
  'remote_access.device_enroll': 'Удалённое устройство подключено',
  'remote_access.device_revoke': 'Удалённое устройство отключено',
  'remote_access.device_revoke_all': 'Все удалённые устройства отключены',
  'remote_access.write_blocked': 'Удалённое изменение заблокировано',
