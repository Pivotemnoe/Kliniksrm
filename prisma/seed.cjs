...
const permissions = [
  ...
  ['acceptance.manage', 'Финальная приёмка нового сервера'],
];
...
const businessCategories = [
  ...
  ['daily_salary', 'Зарплата, выданная за день', 'EXPENSE', 'PAYROLL', true, true, 111],
  ['laboratory_reagents', 'Лабораторные реагенты', 'EXPENSE', 'OPERATING', true, true, 112],
  ['procedure_payout', 'Выплаты за процедуры', 'EXPENSE', 'OPERATING', true, true, 113],
  ['ultrasound_payout', 'Выплаты за УЗИ', 'EXPENSE', 'OPERATING', true, true, 114],
  ['xray_payout', 'Выплаты за рентген', 'EXPENSE', 'OPERATING', true, true, 115],
